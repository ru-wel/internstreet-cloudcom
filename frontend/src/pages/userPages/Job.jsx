      ...
      <div className="lg:grid lg:grid-cols-2 mx-10 mt-5">
        ...
        <div className="lg:flex lg:justify-end lg:mt-24 lg:mr-20 justify-center mt-3">
          <div className="flex md:justify-center">
            <button className=" ml-10 mt-2 text-black rounded-xl px-5 py-2 bg-[#d5efea] border flex items-center">Save  
            ...
            <button className=" ml-10 mt-2 text-black rounded-xl px-5 py-2 bg-[#d5efea] border flex items-center">Share
